...
<section class="flex flex-col gap-[10px]">
    <h2 class="text-h2 font-bold">Share it</h2>
    <p class="text-text-secondary font-medium">Share it</p>
    <div class="flex gap-4 justify-between lg:justify-start">
        @foreach($platforms as $platform)
            <button class="flex items-center font-semibold bg-background-pillButton border border-border-light rounded-full p-2 lg:p-[12px_22px_12px_16px] hover:border-white hover:shadow-sm transition-all">
