...
{{-- Fear & Greed Index Section --}}
    ...
    <div x-data="fearGreedIndex(@js($value))" class="relative w-full lg:w-[33rem]" role="region" aria-label="Fear and Greed Index">
        ...
        <div class="bg-background-primary backdrop-blur-[30px] border border-border-light rounded-[14px] p-5 sm:p-[30px] flex flex-col items-center gap-5">
            {{-- Header --}}
            <div class="w-full flex justify-between items-start">
                <h2 class="font-manrope text-h3 leading-[110%] tracking-[-0.011em] font-bold">
            ...
            <div class="w-full flex flex-col sm:flex-row gap-4">
                ...
                <div class="flex-1 bg-background-tertiary border border-border-light rounded-[14px] p-[10px_30px]">
                    ...
                    <div class="relative">
                        <button
                            type="button"
                            @click="$refs.timeframeSelect.focus()"
                            class="w-full text-left"
                        >
                            <select
                                x-ref="timeframeSelect"
                                x-model="selectedTimeframe"
                                @change="refreshData()"
                                class="w-full bg-background-tertiary border border-none text-white font-manrope text-[2rem] leading-[140%] tracking-[-0.011em] font-bold appearance-none focus:outline-none focus:ring-2 focus:ring-[#177FF0] rounded-[14px] p-0 cursor-pointer"
                            >
                            ...
                            <svg class="absolute right-0 top-1/2 -translate-y-1/2 transform rotate-180 pointer-events-none" width="20" height="20" viewBox="0 0 24 24">
    ...
    >
        <div class="flex justify-between items-center mb-6">
            <h2 class="font-manrope text-h3 leading-[110%] tracking-[-0.011em] font-bold text-white">
