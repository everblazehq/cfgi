...
<section class="flex flex-col lg:flex-row gap-6 w-full mx-auto">
    ...
    <div x-data="fearGreedIndex(@js($cfgData))" class="relative w-full lg:w-[33rem]" role="region" aria-label="Fear and Greed Index">
        ...
        <div
            class="h-full bg-bg-primary backdrop-blur-[30px] border border-border-light rounded-[14px] p-5 sm:p-[30px] flex flex-col justify-between items-center gap-5">
            {{-- Header --}}
            <div class="w-full flex justify-between items-start">
                <h4 class="font-manrope text-h2-medium leading-[110%] tracking-[-0.011em] font-bold">
            ...
            <div class="w-full max-w-[25.9375rem] aspect-square relative mx-auto">
                <x-token-page.fear-greed-index.gauge :value="(int) ($cfgData['0']['cfgi'] ?? 0)" :min="0" :max="100"
                    class="w-full h-full" />
            </div>
            ...
            <div class="w-full flex flex-col sm:flex-row gap-4">
                ...
                <div class="flex-1 bg-bg-tertiary border border-border-light rounded-[14px] p-[10px_30px]">
                    <span class="block text-sm leading-[140%] tracking-[-0.011em] text-white/30 mb-2">
                        <p>Token</p>
                    </span>
                ...
                <div class="flex-1 bg-bg-tertiary border border-border-light rounded-[14px] p-[10px_30px]">
                    <label for="timeframe-select"
                        class="block text-sm leading-[140%] tracking-[-0.011em] text-white/30 mb-2">Temporality</label>
                    <div class="relative">
                        <div class="flex items-center justify-between">
                            <select id="timeframe-select" aria-label="Select timeframe"
                                ...
                                <option class="bg-[#1c1c1c]" value="2">4 hours</option>
                                <option class="bg-[#1c1c1c]" value="3">1 hour</option>
                                <option class="bg-[#1c1c1c]" value="4">15 minutes</option>
                            </select>
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M4.2625 5.5L10 11.6808L15.7375 5.5L17.5 7.40283L10 15.5L2.5 7.40283L4.2625 5.5Z"
                                    fill="white" />
                            </svg>
                        </div>
                    </div>
    ...
    <div class="relative flex-1 bg-bg-primary backdrop-blur-[30px] border border-border-light rounded-[14px] p-[30px]"
        role="region" aria-label="Bitcoin Analysis">
        <div class="flex justify-between items-center mb-6">
            <h4 class="font-manrope text-h2-medium leading-[110%] tracking-[-0.011em] font-bold text-white">
