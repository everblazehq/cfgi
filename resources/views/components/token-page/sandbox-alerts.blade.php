...
<section class="bg-[#131313] border border-border-light rounded-[14px] p-[30px]">
    ...
    <div class="flex justify-between gap-6">
        <div class="flex flex-col justify-center items-center bg-[#171717] border border-border-light rounded-[14px] p-6 flex-1">
